...
//https://blog.csdn.net/cy0208/article/details/80083807
public class HoriStackTransformer implements ViewPager.PageTransformer {
    ...
    public HoriStackTransformer(@NonNull ViewPager boundViewPager) {
    ...
    public void transformPage(@NonNull View view, float position) {
        ...
        float horizontalOffsetBase = (pagerWidth - pagerWidth * CENTER_PAGE_SCALE) / 2 / offscreenPageLimit + 15*boundViewPager.getContext().getResources().getDisplayMetrics().density;
