...
public final class DCON {
    ...
    public final static class Document {
         ...
         *
         * @see #COLUMN_FLAGS
         * @see DCON#getDocumentThumbnail(ContentResolver, Uri,
         ...
         *
         * @see #COLUMN_FLAGS
         * @see DCON#deleteDocument(ContentResolver, Uri)
         ...
         *
         * @see #COLUMN_FLAGS
         * @see DCON#renameDocument(ContentProviderClient, Uri,
         *      String)
    ...
    public final static class Root {
         ...
         *
         * @see #COLUMN_FLAGS
         * @see DCON#buildRecentDocumentsUri(String, String)
         ...
         *
         * @see #COLUMN_FLAGS
         * @see DCON#buildSearchDocumentsUri(String, String,
         *      String)
         ...
         * {@link DCON#buildRootsUri(String)}.
         *
         * @see #COLUMN_FLAGS
    ...
    public static Uri createDocument(ContentProviderClient client, Uri parentDocumentUri,
        ...
        in.putParcelable(DCON.EXTRA_URI, parentDocumentUri);
        in.putString(Document.COLUMN_MIME_TYPE, mimeType);
        in.putString(Document.COLUMN_DISPLAY_NAME, displayName);

        final Bundle out = client.call(METHOD_CREATE_DOCUMENT, null, in);
        return out.getParcelable(DCON.EXTRA_URI);
    }
    ...
    public static Uri renameDocument(ContentProviderClient client, Uri documentUri,
        ...
        final Bundle in = new Bundle();
        in.putParcelable(DCON.EXTRA_URI, documentUri);
        in.putString(Document.COLUMN_DISPLAY_NAME, displayName);

        final Bundle out = client.call(METHOD_RENAME_DOCUMENT, null, in);
        final Uri outUri = out.getParcelable(DCON.EXTRA_URI);
