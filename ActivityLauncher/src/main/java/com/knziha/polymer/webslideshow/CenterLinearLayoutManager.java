 ...
 * https://stackoverflow.com/questions/38416146/
 */
public class CenterLinearLayoutManager extends LinearLayoutManager {
    ...
    private static class CenterSmoothScroller extends LinearSmoothScroller {
        ...
        public int calculateDtToFit(int viewStart, int viewEnd, int boxStart, int boxEnd, int snapPreference) {
			int half = (viewEnd - viewStart) / 2;
			float ret = (boxStart + (boxEnd - boxStart) / 2) - (viewStart + half);
			dst=androidx.core.math.MathUtils.clamp(Math.abs(ret/half), 0, 1);
			CMN.Log("calculateDtToFit", ret, dst);
			return (int) ret;
        }
        ...
        protected float calculateSpeedPerPixel(DisplayMetrics displayMetrics) {
            //return (MathUtils.lerp(1000f, 55f, dst)) / GlobalOptions.densityDpi;
    ...
    @Deprecated
	public static class LinearSmoothScrollerX extends RecyclerView.SmoothScroller {
		...
		public LinearSmoothScrollerX(Context context) {
