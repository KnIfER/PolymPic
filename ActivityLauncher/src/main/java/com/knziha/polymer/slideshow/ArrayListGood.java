...
package com.knziha.polymer.slideshow;
        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
	...
	public interface ArrayCreator<E> {
		E[] newInstance(int initialCapacity);
	}
    /**
     ...
     *         is negative
     */
    public ArrayListGood(int initialCapacity, ArrayCreator<E> mArrayCreator) {
		this.mArrayCreator = mArrayCreator;
		this.elementData = mArrayCreator.newInstance(initialCapacity);
    }
	...
	private E[] EMPTY_ELEMENTDATA() {
		return EMPTY_ELEMENTDATA==null?EMPTY_ELEMENTDATA=mArrayCreator.newInstance(0):EMPTY_ELEMENTDATA;
	}
    ...
    public Object clone() {
        try {
            ArrayListGood<?> v = (ArrayListGood<?>) super.clone();
