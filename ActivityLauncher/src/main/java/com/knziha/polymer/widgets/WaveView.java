 ...
 * waveView
 * https://github.com/ZihYangLin/YPWaveView
 */
...
public class WaveView extends View {
    ...
    private Drawable mShutUpDrawableRes;
    ...
    private WaveStuffListener mListener;
    ...
    public WaveView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mShutUpDrawableRes = attributes.getDrawable(R.styleable.YPWaveView_shutUpDrawable);
    ...
    public WaveStuffListener getListener() {
        return mListener;
    }

    public void setListener(WaveStuffListener mListener) {
...
//        path.close();
        RectF rect = new RectF(0, 0, screenSize.x, screenSize.y);
		float framew = getResources().getDimension(R.dimen.framew1)+2;
		path.addRoundRect(rect,framew,framew,Path.Direction.CW);
        return path;
    }
    ...
    protected void onDraw(Canvas canvas) {
    	if(shutUp) {
    		if(mShutUpDrawableRes!=null) {
				mShutUpDrawableRes.setBounds(0, 0, screenSize.x, screenSize.y);
				mShutUpDrawableRes.draw(canvas);
			}
    		return;
		}
