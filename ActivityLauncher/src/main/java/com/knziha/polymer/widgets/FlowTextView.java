...
public class FlowTextView extends View {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		//CMN.Log("heightMode", heightMode, MeasureSpec.AT_MOST, MeasureSpec.EXACTLY, MeasureSpec.UNSPECIFIED);
		if (heightMode == MeasureSpec.UNSPECIFIED) {
			setMeasuredDimension(getMeasuredWidth(), Math.max(getMeasuredHeight(), mDesiredHeight));
		} else if (heightMode == MeasureSpec.AT_MOST) {
			setMeasuredDimension(getMeasuredWidth(), mDesiredHeight);
		}
	}
